class SocialMedia
  ...
  def GetSocialMediaSites_NiceNames
    return {
      'add.this'=>'AddThis',
      'blogger'=>'Blogger',
      'buffer'=>'Buffer',
  ...
  def GetSocialMediaSites_WithShareLinks_OrderedByAlphabet
    return self.GetSocialMediaSites_NiceNames().keys
  end
  
  def GetSocialMediaSiteLinks_WithShareLinks(args)
    text = args['title']
    ...
    return {
      ...
      'stumbleupon'=>'http://www.stumbleupon.com/submit?url=' + args['url'] + '&title=' + text,
