...
* Unable to find official source.  Requires login to work and precisely formatted URL (with protocal http/https parameters).  Functionality tested and verified by SocialShare Dev's in 2018.
